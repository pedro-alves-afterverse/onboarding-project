...
class DynamoDBProfileDAO(config: Config, private val dynamoDbClient: DynamoDbAsyncClient): ProfileDAO {
    ...
    override suspend fun addItem(profileId: ProfileId, itemId: Int) {
        dynamoDbClient.updateItem(
            UpdateItemRequest.builder()
                ...
                .expressionAttributeValues(mapOf(":val" to intArrayOf(itemId).toAttributeValue()))
                .build()
        )
            .awaitRaiseException()
    }
    ...
    private fun Profile.toItem(): Map<String, AttributeValue> =
        mapOf(
            ...
            ITEMS to items.toIntArray().toAttributeValue(),
